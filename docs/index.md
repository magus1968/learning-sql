...
А ещё потому что:
- Пришлось искать костыльное решение для отображения синтаксиса SQL на созданном сайте: JupySQL подсвечивает синтаксис в блокноте Jupyter, но не на созданном с помощью Jupyter Book сайте. В этот момент идею с сайтом хотелось уже бросить в пользу обычного хранения на GitHub.
