...
- Плюс у _подкожной_ мысли появилось продолжение: а что если доступ к GitHub заблокируют? Смогу ли использовать отечественный [GitVerse](https://gitverse.ru/home/)? Если да – [как использовать GitHub и GitVerse в параллели](https://magus1968.github.io/learning-sql/adv-gitverse/) с одним локальным репозиторием?
