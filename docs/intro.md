...
Вопрос вроде бы был уже решен, но тут появилась _подкожная_ мысль, которая и стала причиной этого гайда: что если для доступа к блокнотам использовать не просто GitHub, а создать статический сайт с функцией поиска?
...
- Плюс у _подкожной_ мысли появилось продолжение: а что если доступ к GitHub заблокируют? Смогу ли использовать отечественный GitVerse? Если да – [как использовать GitHub и GitVerse в параллели](https://magus1968.github.io/learning-sql/adv-gitverse/) с одним локальным репозиторием?

На случай если кому-то мои изыскания будут полезны решил поделиться.
