...
Cервера **GitHub** перехватывают это событие, запускают виртуальную машину, собирают книгу и сами выкладывают её на [сайт](https://magus1968.github.io/learning-sql/).
:::
